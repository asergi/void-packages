...
| Variable        | Value                            |
|-----------------|----------------------------------|
| python2_lib     | /usr/lib/python2.X               |
| python2_sitelib | /usr/lib/python2.X/site-packages |
| python2_include | /usr/include/python2.X           |
| python3_version | 3.X                              |
| python3_lib     | /usr/lib/python3.X               |
| python3_sitelib | /usr/lib/python3.X/site-packages |
| python3_include | /usr/include/python3.Xm          |
